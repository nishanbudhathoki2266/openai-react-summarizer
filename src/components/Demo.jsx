        ...
        <section className="mt-16 w-full max-w-xl">
            ...
            <div className="my-10 max-w-full flex justify-center items-center">
                {isFetching ? <img src={loader} alt="loader" className="w-20 h-20 object-contain" /> :
                    error ? <p className="font-inter font-bold text-black text-center">Hmm... Something went wrong! <span className="font-santoshi font-normal text-gray-700">
                        {error?.data?.error}
                    </span></p> :

                        article.summary && (
                            <div className="flex flex-col gap-3">
                                <h2 className="font-santoshi font-bold text-gray-600 text-xl">Article <span className="blue_gradient">Summary</span></h2>
